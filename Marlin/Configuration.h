...
#define STRING_CONFIG_H_AUTHOR "(Aaron Griffith, TEVO Tarantula i3)" // Who made the changes.
...
#define HOTEND_OFFSET_X {0.0, -17.75} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.2609, 80.2609, 1600, 94.7929 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION 47
