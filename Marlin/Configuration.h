...
#define STRING_CONFIG_H_AUTHOR "Aaron Griffith" // Who made the changes.
...
#define HOTEND_OFFSET_X { 0.0, -17.75 } // (mm) relative X-offset for each nozzle
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 314.07
  #define DEFAULT_bedKi 60.86
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 7, 80 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0196 // (mm) Distance from real junction edge
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -9, +22, -2.40 }
